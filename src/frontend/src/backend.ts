...
export class Backend implements backendInterface {
    ...
    async addOrUpdatePackage(arg0: PricingPackage): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdatePackage(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async addOrUpdatePortfolioItem(arg0: PortfolioItem): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addOrUpdatePortfolioItem(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getAllPackages(): Promise<Array<PricingPackage>> {
        if (this.processError) {
            try {
    ...
    async getPackage(arg0: PackageId): Promise<PricingPackage> {
        if (this.processError) {
            try {
